...
document.getElementById(lidEOMvekoell).innerHTML="ID: "+eid+" <br>Total time: <b id ='ct'>0</b> <br> Total YIM: <b id='yc'>0</b><br>Read: <b style='cursor:pointer;color:green'onclick='vln()'>on</b>";
